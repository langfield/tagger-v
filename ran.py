...
for i,target in enumerate(target_list):
    ...
    os.system('srun -J 10GB-4c --mem 10000 -c 4 -w adamantium python2 /u/user/tagger-v/train.py --train=dataset/eng.train --dev=dataset/eng.testa --test=dataset/eng.testb --pre_emb=' + target)
